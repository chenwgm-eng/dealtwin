"""
数据库迁移脚本：为 OpportunityTask / MeetingPlan 新增 stakeholder_ids 字段，
为 FeedbackRecord 新增 attachments 字段。
...
def main():
    ...
    with app.app_context():
        ...
        try:
            migrations = [
                ('opportunity_task', 'stakeholder_ids', 'TEXT'),
                ('meeting_plan', 'stakeholder_ids', 'TEXT'),
                ('feedback_record', 'attachments', 'TEXT'),
            ]
